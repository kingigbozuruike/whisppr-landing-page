					...
					<StaggerContainer className="max-w-2xl lg:max-w-none w-full">
						...
						<FadeInUpDiv>
							<div className="flex flex-col xs:flex-row gap-3 sm:gap-4 lg:gap-4 mb-6 sm:mb-8 lg:mb-8 w-full max-w-lg">
								<TapButton className="btn-primary text-sm sm:text-base lg:text-lg px-6 sm:px-8 lg:px-8 py-3 sm:py-4 lg:py-4 animate-glow-pulse min-h-[48px] sm:min-h-[52px] flex-1 xs:flex-none">
									Join Waitlist
								</TapButton>
								<TapButton className="btn-glass text-sm sm:text-base lg:text-lg px-6 sm:px-8 lg:px-8 py-3 sm:py-4 lg:py-4 min-h-[48px] sm:min-h-[52px] flex-1 xs:flex-none">
									Watch 20-sec Demo
								</TapButton>
							</div>
						</FadeInUpDiv>
